...
import com.bastien_corre.cleanjava.auth.infra.adapters.jpa.SQLUserDataAccessor;
...
public class AuthConfiguration {
    @Bean
    public UserRepository userRepository(EntityManager entityManager, SQLUserDataAccessor userDataAccessor) {
        return new SQLUserRepository(entityManager, userDataAccessor);
    }
